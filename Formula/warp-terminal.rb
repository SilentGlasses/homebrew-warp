class WarpTerminal < Formula
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://releases.warp.dev/stable/v0.2026.05.13.09.15.stable_01/Warp-x86_64.AppImage" # x86_64_url
      sha256 "4346f01014b5a3fce54a95d8d4421e7cea482eb4db461aee4f7db95bd5bcf0db" # x86_64_sha256
    elsif Hardware::CPU.arm?
      url "https://releases.warp.dev/stable/v0.2026.05.13.09.15.stable_01/Warp-aarch64.AppImage" # arm64_url
      sha256 "242c8edb1224545532b91f867c9c4cdbfbb200973193d45d6aa0710f1298b725" # arm64_sha256
    end
  end
